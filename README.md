...
Importeer de sql tabel
open inlog.php 
volg de navigatie


Userstories:
als gebruiker wil ik een server kunnen maken zodat andere mensen met mij kunnen spelen 
als gebruiker wil ik een rating systeem zodat ik mijn skills met die van andere spelers kan vergelijken
als gebruiker wil ik het profiel van andere spelers kunnen zoeken zodat ik de statistieken van andere spelers kan zien
...
https://www.w3schools.com/php/php_ref_output_control.asp
